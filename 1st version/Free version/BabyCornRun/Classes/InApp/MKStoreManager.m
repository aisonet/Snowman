...
static NSString *featureAId = @"com.touhid.snowmanfreer.removeadds";////ad
static NSString *featureBId = @"com.touhid.snowmanfreer.10lives";///10 lifes
static NSString *featureCId = @"com.touhid.snowmanfreer.1revive";//1 revive
static NSString *featureDId = @"com.touhid.snowmanfreer.3revive";///3 revive
