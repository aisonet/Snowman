...
static NSString *featureAId = @"com.tasnim.snowmanpror.noads";////ad
static NSString *featureBId = @"com.touhid.snowmanpror.10lives";///10 lifes
static NSString *featureCId = @"com.touhid.snowmanpror.1revive";//1 revive
static NSString *featureDId = @"com.touhid.snowmanpror.3revive";///3 revive
...
- (void) requestProductData
{
	SKProductsRequest *request= [[SKProductsRequest alloc] initWithProductIdentifiers: 
								 [NSSet setWithObjects:  featureBId, featureCId, featureDId, nil]]; // add any other product here
...
- (void) buyFeature:(NSString*) featureId
{
	...
	{
		UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Baby Horse Run Pro" message:@"You are not authorized to purchase from AppStore"
